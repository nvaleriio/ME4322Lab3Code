...
%% Assumptions
% All links are rigid
% No friction acts on the joints and pivots
% Spring mass is negligible
% Assuming ring is completely attached to the V Lever
% Assumng MMoI of L-piece to be 8.5 x 10^-6 kg m^2
% Ideal system, no loss of energy due to vibrations
% Assume MMoI of 3.2 x 10^-8 kg m^2 for pinion
% Bottom plate is assumed to be ground
% Assume all levers are rectangular for MMoI
% L-piece that moves rack is rigidly attached to V Lever
% Assuming initial velocity is zero
% Using K = d^4*G/(64*R^3*n)
% Assuming the use of an equivalent force at each link for the calculation of Deq
